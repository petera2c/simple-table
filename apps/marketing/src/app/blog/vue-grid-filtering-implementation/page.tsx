...
export default function Page() {
  return (
    <FrameworkTutorialLayout
      ...
      ctaDescription="Simple Table for Vue ships column filters, quick filter, and custom predicates in one source-available package—84.6 kB gzipped, Composition-API-friendly."
