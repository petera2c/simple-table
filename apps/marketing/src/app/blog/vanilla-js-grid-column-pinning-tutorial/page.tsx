  ...
  return (
    <FrameworkTutorialLayout
      ...
      introParagraphs={[
        ...
        "If you also need virtualization, grouping with aggregations, and inline editing alongside pinning, simple-table-core is the focused source-available pick—84.6 kB gzipped, framework-agnostic.",
      ]}
      whyItMatters={[
      ...
      ctaDescription="simple-table-core ships left/right pinning, virtualization, and grouping in one source-available package—84.6 kB gzipped, strict TypeScript, ESM-first."
