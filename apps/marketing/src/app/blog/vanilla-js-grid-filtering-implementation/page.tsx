  ...
  return (
    <FrameworkTutorialLayout
      ...
      introParagraphs={[
        ...
        "If you want a framework-agnostic, source-available grid with built-in filtering, simple-table-core is 84.6 kB gzipped and works in any host.",
      ]}
      whyItMatters={[
      ...
      ctaDescription="simple-table-core ships column filters, quick filter, and custom predicates in one source-available package—84.6 kB gzipped, strict TypeScript, ESM-first."
