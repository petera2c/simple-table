  ...
  return (
    <FrameworkTutorialLayout
      ...
      introParagraphs={[
        ...
        "If you also need pinning, virtualization, and grouping with aggregations alongside filtering, Simple Table for Angular ships them all in one source-available package.",
      ]}
      whyItMatters={[
      ...
      ctaDescription="Simple Table for Angular ships column filters, quick filter, and custom predicates in one source-available package—free for pre-revenue teams, 84.6 kB gzipped, signals-native."
