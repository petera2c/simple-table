  ...
  return (
    <FrameworkTutorialLayout
      ...
      introParagraphs={[
        ...
        "If you also need pinning, virtualization, and grouping with aggregations, Simple Table for Vue ships them all in one source-available package—84.6 kB gzipped, Composition-API-friendly.",
      ]}
      whyItMatters={[
      ...
      conclusionParagraphs={[
        ...
        "If you need resize alongside virtualization, pinning, and grouping, Simple Table for Vue is the focused source-available pick—84.6 kB gzipped.",
      ]}
      relatedLinks={[
      ...
      ctaDescription="Simple Table for Vue ships resize, pinning, grouping, and editing in one source-available package—84.6 kB gzipped, Composition-API-friendly, Nuxt-ready."
