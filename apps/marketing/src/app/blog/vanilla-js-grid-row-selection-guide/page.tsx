  ...
  return (
    <FrameworkTutorialLayout
      ...
      introParagraphs={[
        ...
        "If you want a framework-agnostic, strict-TypeScript core grid that works in any host (web component, micro-frontend, plain HTML), simple-table-core is 84.6 kB gzipped and source-available.",
      ]}
      whyItMatters={[
      ...
      ctaDescription="simple-table-core ships single, multi, and checkbox selection in one source-available package—84.6 kB gzipped, strict TypeScript, ESM-first."
