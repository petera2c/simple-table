...
export const metadata: Metadata = {
  ...
  keywords:
    "handsontable alternative, handsontable vanilla js alternative, typescript data grid, simple-table-core, free spreadsheet alternative",
  openGraph: {
    title: simpleTableVsHandsontableVanillaPost.title,
    description: simpleTableVsHandsontableVanillaPost.description,
    type: "article",
...
export default function Page() {
  return (
    <CompetitorBlogLayout
      ...
      title={simpleTableVsHandsontableVanillaPost.title}
      subtitle="Handsontable's non-commercial license blocks production SaaS use without a paid license. simple-table-core is source-available—free for pre-revenue teams, with Pro/Enterprise for revenue-generating use—and ships virtualization, pinning, grouping, and editing in vanilla TypeScript."
      ...
      introParagraphs={[
        ...
        "simple-table-core is source-available: free for pre-revenue teams, with a Pro/Enterprise license required for revenue-generating use. This article covers the licensing trade-off and how feature scope compares.",
      ]}
      comparisonRows={[
      ...
      scenarios={[
        ...
        },
        {
          ...
          recommendationLabel: "Switch to simple-table-core—source-available, free for pre-revenue teams.",
        },
        {
          emoji: "📈",
