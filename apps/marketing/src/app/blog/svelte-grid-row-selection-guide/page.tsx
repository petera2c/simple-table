  ...
  return (
    <FrameworkTutorialLayout
      ...
      introParagraphs={[
        ...
        "If you also need pinning, virtualization, and grouping with aggregations alongside selection, Simple Table for Svelte is the focused source-available pick.",
      ]}
      whyItMatters={[
      ...
      ctaDescription="Simple Table for Svelte ships single, multi, and checkbox selection in one source-available package—84.6 kB gzipped, Svelte 5 runes ready."
