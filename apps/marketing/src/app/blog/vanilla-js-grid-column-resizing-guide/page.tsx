  ...
  return (
    <FrameworkTutorialLayout
      ...
      introParagraphs={[
        ...
        "If you want a strict-TypeScript, ESM-first, source-available core grid that you can mount in any framework or no framework, simple-table-core is 84.6 kB gzipped with built-in resize, pinning, and virtualization.",
      ]}
      whyItMatters={[
      ...
      pitfalls={[
        ...
        { title: "Bundle size", problem: "Tabulator and Handsontable add 200-400 kB to your bundle.", solution: "If you don't need every feature, simple-table-core is 84.6 kB gzipped with the same core capabilities." },
      ...
      conclusionParagraphs={[
        ...
        "If you need a framework-agnostic, strict-TypeScript core grid with resize, pinning, and virtualization, simple-table-core is the focused source-available pick—84.6 kB gzipped.",
      ]}
      relatedLinks={[
      ...
      ctaDescription="simple-table-core ships resize, pinning, grouping, and editing in one source-available package—84.6 kB gzipped, strict TypeScript, ESM-first."
