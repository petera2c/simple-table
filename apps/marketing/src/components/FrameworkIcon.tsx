...
function SolidLogo({ size = 16, className }: { size?: number; className?: string }) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={a} x1="27.5" y1="3" x2="152" y2="63.5" gradientUnits="userSpaceOnUse">
          <stop offset="0.1" stopColor="#76b3e1" />
          <stop offset="0.3" stopColor="#dcf2fd" />
          <stop offset="1" stopColor="#76b3e1" />
        </linearGradient>
        <linearGradient id={b} x1="95.8" y1="32.6" x2="74" y2="105.2" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#76b3e1" />
          <stop offset="0.5" stopColor="#4377bb" />
          <stop offset="1" stopColor="#1f3b77" />
        </linearGradient>
        <linearGradient id={c} x1="18.4" y1="64.2" x2="144.3" y2="149.8" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#315aa9" />
          <stop offset="0.5" stopColor="#518ac8" />
          <stop offset="1" stopColor="#315aa9" />
        </linearGradient>
        <linearGradient id={d} x1="75.2" y1="74.5" x2="24.4" y2="260.8" gradientUnits="userSpaceOnUse">
