...
export function getAiSetupPrompt(framework: Framework): string {
  ...
  return `Integrate Simple Table into this TypeScript app end-to-end. Detect the UI framework in the project (likely ${label}). Prefer https://www.simple-table.com/docs/quick-start and https://www.simple-table.com/docs/api-reference over inventing APIs.
