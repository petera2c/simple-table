...
export const SEO_STRINGS = {
  ...
  blogPosts: {
    ...
    reactPivotTable: {
      ...
      keywords: [
        ...
        "pivot table react",
        "how to build a pivot table in react",
        "matrix pivot react",
        "react data grid pivot",
        "ag grid pivot alternative",
        "ag grid pivot mode free alternative",
        "declarative pivot table",
        "react pivot aggregation",
        "javascript pivot table",
        "typescript pivot table",
        "free react pivot table",
        "react analytics pivot",
        "pivot rows columns values",
        "simple table pivot",
        "react pivot panel",
        "react cross tab table",
      ],
    },
    ...
    reactCustomCellRenderer: {
      title: reactCustomCellRendererPost.title,
      description: reactCustomCellRendererPost.description,
      keywords: [
        "react table custom cell renderer",
        "react table cell renderer",
        "react data grid cell renderer",
        "custom cell react table",
        "react table render component in cell",
        "react table badge column",
        "react table progress bar column",
        "react table button column",
        "react table custom cell",
        "react table cell formatting",
        "react table avatar column",
        "react table status badge",
        "react table conditional formatting",
        "cellRenderer react",
        "react table valueFormatter vs cellRenderer",
        "react table render react component",
        "react grid custom cell component",
        "react table action buttons column",
        "react table custom column rendering",
        "react table rich cells",
      ],
    },
    reactTableInfiniteScroll: {
      title: reactTableInfiniteScrollPost.title,
      description: reactTableInfiniteScrollPost.description,
      keywords: [
        "react table infinite scroll",
        "react table lazy loading",
        "react table server side",
        "react data grid infinite scroll",
        "load more rows react table",
        "react table virtualization",
        "react table onLoadMore",
        "infinite scroll react data grid",
        "react table large dataset",
        "react table million rows",
        "react table server side pagination",
        "react table scroll pagination",
        "react table window scroll",
        "react table sticky header scroll",
        "react grid lazy load data",
        "react table fetch on scroll",
        "react table append rows on scroll",
        "react table performance large data",
        "react infinite scrolling table",
        "react table load data on demand",
      ],
    },
    nestedTablesReact: {
  ...
  examples: {
    ...
    analytics: {
      title: "Analytics Pivot Table Demo: Revenue Matrix with Simple Table",
      description:
        "Live analytics pivot table demo: region, product, channel, and quarter matrices with sum and average aggregations in a JavaScript data grid. Try declarative React pivot presets.",
      keywords:
        "analytics pivot table, react pivot table demo, revenue analytics table, matrix pivot demo, region quarter pivot, data aggregation table, simple-table pivot, javascript data grid, react data grid pivot",
    },
    crypto: {
  ...
  pricing: {
    ...
    description:
      "Simple Table pricing: free until your company makes money. Pro $85/mo or $850/yr. Enterprise $350/mo or $3,500/yr with direct developer access. No per-seat fees. React, Vue, Angular, Svelte, Solid, and vanilla JavaScript or TypeScript.",
    keywords:
