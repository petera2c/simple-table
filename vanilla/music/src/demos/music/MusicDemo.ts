...
function buildMusicHeaders(theme?: string): ColumnDef<MusicArtist>[] {
  ...
  return [
    ...
    { accessor: "artistName", label: "Artist", width: "auto", sortable: true, editable: false, align: "left", type: "string", pinned: "left", cellRenderer: artistRenderer },
    { accessor: "artistType", label: "Identity", width: "auto", sortable: false, editable: false, align: "left", type: "string", cellRenderer: artistTypeRenderer },
    {
      accessor: "followersGroup", label: "Followers", width: "auto", collapsible: true,
      children: [
        { accessor: "followers", label: "Total Followers", width: "auto", showWhen: "always", sortable: true, editable: false, type: "number", cellRenderer: followersRenderer },
        { accessor: "followers7DayGrowth", label: "7-Day Growth", width: "auto", sortable: true, editable: false, align: "right", type: "number", showWhen: "parentExpanded", cellRenderer: growthCell("followers7DayGrowth", "followers7DayGrowthPercent", false) },
        { accessor: "followers28DayGrowth", label: "28-Day Growth", width: "auto", sortable: true, editable: false, align: "right", type: "number", showWhen: "parentExpanded", cellRenderer: growthCell("followers28DayGrowth", "followers28DayGrowthPercent", false) },
        { accessor: "followers60DayGrowth", label: "60-Day Growth", width: "auto", sortable: true, editable: false, align: "right", type: "number", showWhen: "parentExpanded", cellRenderer: growthCell("followers60DayGrowth", "followers60DayGrowthPercent", false) },
      ],
    },
    { accessor: "popularity", label: "Popularity", width: "auto", sortable: true, editable: false, align: "center", type: "number", cellRenderer: popularityRenderer },
    {
      accessor: "playlistReachGroup", label: "Playlist Reach", width: "auto", collapsible: true,
      children: [
        { accessor: "playlistReach", label: "Total Reach", width: "auto", showWhen: "always", sortable: true, editable: false, type: "number", cellRenderer: playlistReachRenderer },
        { accessor: "playlistReach7DayGrowth", label: "7-Day Growth", width: "auto", sortable: true, editable: false, align: "right", type: "number", showWhen: "parentExpanded", cellRenderer: growthCell("playlistReach7DayGrowth", "playlistReach7DayGrowthPercent", true) },
        { accessor: "playlistReach28DayGrowth", label: "28-Day Growth", width: "auto", sortable: true, editable: false, align: "right", type: "number", showWhen: "parentExpanded", cellRenderer: growthCell("playlistReach28DayGrowth", "playlistReach28DayGrowthPercent", true) },
        { accessor: "playlistReach60DayGrowth", label: "60-Day Growth", width: "auto", sortable: true, editable: false, align: "right", type: "number", showWhen: "parentExpanded", cellRenderer: growthCell("playlistReach60DayGrowth", "playlistReach60DayGrowthPercent", true) },
      ],
    },
    {
      accessor: "playlistCountGroup", label: "Playlist Count", width: "auto", collapsible: true,
      children: [
        { accessor: "playlistCount", label: "Total Count", width: "auto", showWhen: "always", sortable: true, editable: false, type: "number", cellRenderer: playlistCountRenderer },
        { accessor: "playlistCount7DayGrowth", label: "7-Day Growth", width: "auto", sortable: true, editable: false, align: "right", type: "number", showWhen: "parentExpanded", cellRenderer: growthCell("playlistCount7DayGrowth", "playlistCount7DayGrowthPercent", false) },
        { accessor: "playlistCount28DayGrowth", label: "28-Day Growth", width: "auto", sortable: true, editable: false, align: "right", type: "number", showWhen: "parentExpanded", cellRenderer: growthCell("playlistCount28DayGrowth", "playlistCount28DayGrowthPercent", false) },
        { accessor: "playlistCount60DayGrowth", label: "60-Day Growth", width: "auto", sortable: true, editable: false, align: "right", type: "number", showWhen: "parentExpanded", cellRenderer: growthCell("playlistCount60DayGrowth", "playlistCount60DayGrowthPercent", false) },
      ],
    },
    {
      accessor: "monthlyListenersGroup", label: "Monthly Listeners", width: "auto", collapsible: true,
      children: [
        { accessor: "monthlyListeners", label: "Total Listeners", width: "auto", showWhen: "always", sortable: true, editable: false, type: "number", cellRenderer: monthlyListenersRenderer },
        { accessor: "monthlyListeners7DayGrowth", label: "7-Day Growth", width: "auto", sortable: true, editable: false, align: "right", type: "number", showWhen: "parentExpanded", cellRenderer: growthCell("monthlyListeners7DayGrowth", "monthlyListeners7DayGrowthPercent", true) },
        { accessor: "monthlyListeners28DayGrowth", label: "28-Day Growth", width: "auto", sortable: true, editable: false, align: "right", type: "number", showWhen: "parentExpanded", cellRenderer: growthCell("monthlyListeners28DayGrowth", "monthlyListeners28DayGrowthPercent", true) },
        { accessor: "monthlyListeners60DayGrowth", label: "60-Day Growth", width: "auto", sortable: true, editable: false, align: "right", type: "number", showWhen: "parentExpanded", cellRenderer: growthCell("monthlyListeners60DayGrowth", "monthlyListeners60DayGrowthPercent", true) },
      ],
    },
    { accessor: "conversionRate", label: "Conversion Rate", width: "auto", sortable: true, editable: false, align: "right", type: "number", cellRenderer: conversionRateRenderer },
    { accessor: "reachFollowersRatio", label: "Reach/Followers Ratio", width: "auto", sortable: true, editable: false, align: "right", type: "number", cellRenderer: ratioRenderer },
  ];
}
