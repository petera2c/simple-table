...
const TableSectionInner = <T,>(
  ...
  const { rowIdAccessor } = useTableContext<T>();
...
const TableSection = forwardRef(TableSectionInner) as <T>(
  props: TableSectionProps<T> & { ref?: ForwardedRef<HTMLDivElement> }
) => JSX.Element;
