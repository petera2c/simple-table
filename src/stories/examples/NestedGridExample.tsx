...
const divisionTypes = [
  "Cloud Services", "AI Research", "Consumer Products", "Investment Banking",
  "Retail Banking", "Research & Development", "Operations", "Sales & Marketing",
  "Customer Success", "Engineering", "Product Development", "Analytics",
  "Infrastructure", "Security", "Data Science"
];

const teamTypes = [
  "Infrastructure", "Security", "Machine Learning", "M&A Advisory",
  "Frontend Development", "Backend Services", "DevOps", "Quality Assurance",
  "Product Management", "Data Engineering", "Mobile Development", "Platform",
  "API Services", "Business Intelligence", "Customer Analytics"
];

const skills = [
  "Kubernetes", "Deep Learning", "Financial Modeling", "React", "Python",
  "Cloud Architecture", "Data Analytics", "Cybersecurity", "Blockchain",
  "Machine Learning", "DevOps", "Product Strategy", "AWS", "TypeScript"
];

const awards = [
  "Best Team 2023", "Innovation Award", "Security Excellence", "Deal of the Year",
  "Outstanding Performance", "Excellence in Innovation", "Top Performer",
  "Best in Class", "Industry Leader", "Customer Choice", null, null
];
...
const generateDivision = (divisionIndex: number, companyIndex: number, hasTeams: boolean = true) => {
...
const generateCompany = (companyIndex: number) => {
  ...
  const companyNames = [
    "TechCorp", "FinanceHub", "HealthTech", "GlobalSystems", "InnovateLabs",
    "FutureTech", "DataWorks", "CloudFirst", "SmartSolutions", "NextGen",
    "PrimeVentures", "AlphaGroup", "BetaSystems", "GammaIndustries", "DeltaCorp"
  ];
  ...
  return {
    ...
    stockSymbol: Array.from({ length: 4 }, () => 
    ...
    <div style={{ padding: "20px" }}>
      <div style={{ marginBottom: "20px" }}>
        ...
        <ul style={{ margin: "8px 0", color: "#666", fontSize: "14px" }}>
          ...
          <li>
            <strong>Divisions (Level 1):</strong> 3 columns - simplified division metrics (3-7 per company)
          </li>
          <li>
            <strong>Teams (Level 2):</strong> 19 columns - detailed team information (2-5 per division)
          </li>
        </ul>
        <p style={{ margin: "8px 0 0 0", color: "#666", fontSize: "14px" }}>
          Each level has its own independent grid structure with different column counts and headers.
          Data is procedurally generated with realistic variations.
        </p>
      </div>
