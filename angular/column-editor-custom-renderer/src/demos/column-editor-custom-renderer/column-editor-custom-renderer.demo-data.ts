...
export const columnEditorCustomRendererHeaders: AngularColumnDef<ColumnEditorCustomRendererEmployee, any>[] = [
  ...
  { accessor: "role", label: "Role", width: 130, type: "string", sortable: true },
  {
    ...
    type: "number",
    sortable: true,
    valueFormatter: ({ value }: ValueFormatterProps<ColumnEditorCustomRendererEmployee, number>) => `$${value.toLocaleString()}`,
  },
