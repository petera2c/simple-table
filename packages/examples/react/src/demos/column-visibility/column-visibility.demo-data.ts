...
import type { ColumnVisibilityState, ReactColumnDef } from "@simple-table/react";
...
export const columnVisibilityHeaders: ReactColumnDef<VisibilityEmployee>[] = [
...
): ReactColumnDef<VisibilityEmployee>[] {
