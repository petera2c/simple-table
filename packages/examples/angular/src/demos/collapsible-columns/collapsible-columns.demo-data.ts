...
import type { CellRenderer, AngularColumnDef } from "@simple-table/angular";
...
const monthCol = (
  accessor: MonthKey,
  label: string,
): AngularColumnDef<CollapsibleSalesRep, number> => ({
  accessor,
  label,
  width: 100,
...
export const collapsibleColumnsHeaders: AngularColumnDef<CollapsibleSalesRep>[] = [
