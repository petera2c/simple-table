...
export const dynamicNestedTablesDivisionHeaders: AngularColumnDef<DynamicDivision>[] = [
...
export const dynamicNestedTablesCompanyHeaders: AngularColumnDef<DynamicCompany>[] = [
  {
