...
function generateMonthHeaders(): SvelteColumnDef<BillingRow>[] {
  const headers: SvelteColumnDef<BillingRow>[] = [];
  const year = 2024;
...
export const billingHeaders: SvelteColumnDef<BillingRow>[] = [
  {
    accessor: "name",
    label: "Name",
    width: "auto",
