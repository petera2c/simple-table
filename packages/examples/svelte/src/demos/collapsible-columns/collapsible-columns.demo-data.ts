...
import type { CellRenderer, SvelteColumnDef } from "@simple-table/svelte";
...
const monthCol = (
  accessor: MonthKey,
  label: string,
): SvelteColumnDef<CollapsibleSalesRep, number> => ({
  accessor,
  label,
  width: 100,
...
export const collapsibleColumnsHeaders: SvelteColumnDef<CollapsibleSalesRep>[] = [
