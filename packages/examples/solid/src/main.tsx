...
const registry: Record<string, ReturnType<typeof lazy>> = {
  ...
  "programmatic-control": lazy(() => import("./demos/programmatic-control/ProgrammaticControlDemo")),
  ...
  "column-editor-custom-renderer": lazy(() => import("./demos/column-editor-custom-renderer/ColumnEditorCustomRendererDemo")),
  ...
  "dynamic-nested-tables": lazy(() => import("./demos/dynamic-nested-tables/DynamicNestedTablesDemo")),
