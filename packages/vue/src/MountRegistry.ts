/**
 * Tracks imperative Vue mounts created for custom cell/header/footer renderers
 * so they can be torn down when core discards their host elements.
 *
 ...
 * detaches the mount target while the Vue app (and any `<Teleport>` / floating
 * UI) stays alive.
 */
