...
export const dynamicNestedTablesDivisionHeaders: VueColumnDef<DynamicDivision>[] = [
...
export const dynamicNestedTablesCompanyHeaders: VueColumnDef<DynamicCompany>[] = [
  {
