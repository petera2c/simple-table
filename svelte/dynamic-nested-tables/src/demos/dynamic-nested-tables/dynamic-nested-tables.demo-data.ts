...
export const dynamicNestedTablesDivisionHeaders: SvelteColumnDef<DynamicDivision>[] = [
...
export const dynamicNestedTablesCompanyHeaders: SvelteColumnDef<DynamicCompany>[] = [
  {
