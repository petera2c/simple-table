...
export const hrHeaders: SvelteColumnDef<HREmployee>[] = [
  ...
  { accessor: "salary", label: "Salary", width: "auto", sortable: true, editable: true, align: "right", type: "number", valueFormatter: ({ value }) => { if (typeof value !== "number") return ""; return `$${value.toLocaleString()}`; }, useFormattedValueForClipboard: true, useFormattedValueForCSV: true },
  {
